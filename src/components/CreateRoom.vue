    ...
    <div class="create_room" v-on:click.stop>
      ...
      <div class="bottom_buttons" role="group" id="toolBtns">
        ...
        <div class="create_button_container">
          <button role="button" class="btn btn-lg btn-primary bottom_buttons_create" v-on:click="create"> Create </button>       
        </div>
      </div>
    </div>
  </div>
...
import { RoomSettings } from '@/components/Frontpage.vue';
  ...
  export default class CreateRoom extends Vue{
    ...
    public settings: RoomSettings[] = [{id: 0, label: "Collaboration mode", value: false}/*, {id: 1, label: "Song recommendations", value: true}*/];
